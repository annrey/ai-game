...
export interface GameConfig {
  /** 游戏模式 */
  mode: 'text-adventure' | 'chat-roleplay' | 'npc-sandbox' | 'ai-battle' | 'stardew-valley';
  /** 游戏主题 */
  theme: string;
  /** 是否启用战斗系统 */
...
/** 游戏模式 */
export type GameMode = 'text-adventure' | 'chat-roleplay' | 'npc-sandbox' | 'ai-battle' | 'stardew-valley';
