...
import { createStardewValley, StardewTemplates } from './modes/stardew-valley.js';
import type { GameEngine } from './engine/game-engine.js';
import type { GameMode } from '@openclaw/shared-types';
import { GameModeNames } from '@openclaw/shared-types';
...
async function main() {
  ...
  switch (mode) {
    ...
    case 'chat-roleplay':
      ...
      break;
    case 'stardew-valley':
      engine = createStardewValley(factory, DATA_PATH);
