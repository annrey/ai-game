...
import type { GameTime, EnvironmentState, NPCState, Action, Resolution, PlotPoint, PlayerState, Quest, SceneState } from '@openclaw/shared-types';
import type { SaveData, GameMode } from '@openclaw/shared-types';
