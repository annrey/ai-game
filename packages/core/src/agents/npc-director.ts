...
import type { NPCState, GameTime, Quest } from '@openclaw/shared-types';
import { MemoryManager } from '@openclaw/memory';
import type { MemoryType } from '@openclaw/memory';
import { ScheduleManager } from '../engine/schedule-manager.js';
import { TAVERN_NPC_SCHEDULES } from '@openclaw/shared-types';
import { RelationshipManager } from '../engine/relationship-manager.js';
import { TAVERN_NPC_RELATIONSHIPS } from '@openclaw/shared-types';
...
export class NPCDirector extends BaseAgent {
  ...
  /** 更新日程并获取出现/离开事件 */
  updateSchedule(): import('@openclaw/shared-types').NPCPresenceEvent[] {
  ...
  recordSocialInteraction(
    initiatorId: string,
    receiverId: string,
    type: import('@openclaw/shared-types').SocialInteraction['type'],
    content: string,
